...
namespace LearnSaveAttachmentOnServer.Blazor.Server {
    public partial class LearnSaveAttachmentOnServerBlazorApplication : BlazorApplication {
        public LearnSaveAttachmentOnServerBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void LearnSaveAttachmentOnServerBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
